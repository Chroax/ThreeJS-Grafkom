...
for ( let i = 0; i < 100; i ++ ) {
	...
	points.push( new THREE.Vector2( Math.sin( i ) * 10 + 5, i  ) );
}
...
document.addEventListener("keydown", (event) => {
    ...
    else if(name == "d") lathe.position.x += 1;
    else if(name == "a") lathe.position.x += -1;
    else if(name == "w") lathe.position.y += 1;
    else if(name == "s") lathe.position.y += -1;
    else if(name == "e") lathe.position.z += 1;
    else if(name == "q") lathe.position.z += -1;
